...
export class BlindedHopFeatures extends CommonBase {
     ...
     */
    write() {
        const ret = bindings.BlindedHopFeatures_write(this.ptr);
    ...
    static constructor_read(ser) {
        const ret = bindings.BlindedHopFeatures_read(bindings.encodeUint8Array(ser));
        const ret_hu_conv = Result_BlindedHopFeaturesDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    eq(b) {
        const ret = bindings.BlindedHopFeatures_eq(this.ptr, CommonBase.get_ptr_of(b));
        CommonBase.add_ref_from(this, b);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.BlindedHopFeatures_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.BlindedHopFeatures_clone(this.ptr);
     ...
     */
    hash() {
        const ret = bindings.BlindedHopFeatures_hash(this.ptr);
        return ret;
    }
    /**
    ...
    static constructor_empty() {
        const ret = bindings.BlindedHopFeatures_empty();
        const ret_hu_conv = new BlindedHopFeatures(null, ret);
     ...
     */
    le_flags() {
        const ret = bindings.BlindedHopFeatures_le_flags(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
    ...
    supports_any_optional_bits() {
        const ret = bindings.BlindedHopFeatures_supports_any_optional_bits(this.ptr);
        return ret;
    }
    /**
    ...
    requires_unknown_bits_from(other) {
        const ret = bindings.BlindedHopFeatures_requires_unknown_bits_from(this.ptr, CommonBase.get_ptr_of(other));
    ...
    required_unknown_bits_from(other) {
        const ret = bindings.BlindedHopFeatures_required_unknown_bits_from(this.ptr, CommonBase.get_ptr_of(other));
    ...
    requires_unknown_bits() {
        const ret = bindings.BlindedHopFeatures_requires_unknown_bits(this.ptr);
        return ret;
    }
    /**
    ...
    supports_unknown_bits() {
        const ret = bindings.BlindedHopFeatures_supports_unknown_bits(this.ptr);
        return ret;
    }
    /**
    ...
    set_required_feature_bit(bit) {
        const ret = bindings.BlindedHopFeatures_set_required_feature_bit(this.ptr, bit);
    ...
    set_optional_feature_bit(bit) {
        const ret = bindings.BlindedHopFeatures_set_optional_feature_bit(this.ptr, bit);
        const ret_hu_conv = Result_NoneNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
    ...
    set_required_custom_bit(bit) {
        const ret = bindings.BlindedHopFeatures_set_required_custom_bit(this.ptr, bit);
        const ret_hu_conv = Result_NoneNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
    ...
    set_optional_custom_bit(bit) {
        const ret = bindings.BlindedHopFeatures_set_optional_custom_bit(this.ptr, bit);
        const ret_hu_conv = Result_NoneNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
//# sourceMappingURL=BlindedHopFeatures.mjs.map