...
export class Bolt12Invoice extends CommonBase {
    ...
    clone_ptr() {
        const ret = bindings.Bolt12Invoice_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.Bolt12Invoice_clone(this.ptr);
        const ret_hu_conv = new Bolt12Invoice(null, ret);
     ...
     */
    created_at() {
        const ret = bindings.Bolt12Invoice_created_at(this.ptr);
        return ret;
    }
    /**
     * Duration since
     ...
     */
    relative_expiry() {
        const ret = bindings.Bolt12Invoice_relative_expiry(this.ptr);
        return ret;
    }
    /**
     ...
     */
    fallbacks() {
        const ret = bindings.Bolt12Invoice_fallbacks(this.ptr);
     ...
     */
    invoice_features() {
        const ret = bindings.Bolt12Invoice_invoice_features(this.ptr);
     ...
     */
    signing_pubkey() {
        const ret = bindings.Bolt12Invoice_signing_pubkey(this.ptr);
     ...
     */
    offer_chains() {
        const ret = bindings.Bolt12Invoice_offer_chains(this.ptr);
     ...
     */
    chain() {
        const ret = bindings.Bolt12Invoice_chain(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    metadata() {
        const ret = bindings.Bolt12Invoice_metadata(this.ptr);
     ...
     */
    amount() {
        const ret = bindings.Bolt12Invoice_amount(this.ptr);
     ...
     */
    offer_features() {
        const ret = bindings.Bolt12Invoice_offer_features(this.ptr);
     ...
     */
    description() {
        const ret = bindings.Bolt12Invoice_description(this.ptr);
     ...
     */
    absolute_expiry() {
        const ret = bindings.Bolt12Invoice_absolute_expiry(this.ptr);
     ...
     */
    issuer() {
        const ret = bindings.Bolt12Invoice_issuer(this.ptr);
        const ret_hu_conv = new PrintableString(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
     ...
     */
    message_paths() {
        const ret = bindings.Bolt12Invoice_message_paths(this.ptr);
     ...
     */
    supported_quantity() {
        const ret = bindings.Bolt12Invoice_supported_quantity(this.ptr);
     ...
     */
    payer_metadata() {
        const ret = bindings.Bolt12Invoice_payer_metadata(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
    ...
    invoice_request_features() {
        const ret = bindings.Bolt12Invoice_invoice_request_features(this.ptr);
     ...
     */
    quantity() {
        const ret = bindings.Bolt12Invoice_quantity(this.ptr);
        const ret_hu_conv = Option_u64Z.constr_from_ptr(ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
     ...
     */
    payer_id() {
        const ret = bindings.Bolt12Invoice_payer_id(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    payer_note() {
        const ret = bindings.Bolt12Invoice_payer_note(this.ptr);
        const ret_hu_conv = new PrintableString(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
     ...
     */
    payment_hash() {
        const ret = bindings.Bolt12Invoice_payment_hash(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    amount_msats() {
        const ret = bindings.Bolt12Invoice_amount_msats(this.ptr);
        return ret;
    }
    /**
     ...
     */
    signature() {
        const ret = bindings.Bolt12Invoice_signature(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    signable_hash() {
        const ret = bindings.Bolt12Invoice_signable_hash(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    verify_using_metadata(key) {
        const ret = bindings.Bolt12Invoice_verify_using_metadata(this.ptr, CommonBase.get_ptr_of(key));
        const ret_hu_conv = Result_ThirtyTwoBytesNoneZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, key);
        return ret_hu_conv;
    }
    /**
     * Verifies that the invoice was for a request or refund created using the given key by
     ...
     * sent through.
     */
    verify_using_payer_data(payment_id, nonce, key) {
        const ret = bindings.Bolt12Invoice_verify_using_payer_data(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), CommonBase.get_ptr_of(nonce), CommonBase.get_ptr_of(key));
        const ret_hu_conv = Result_ThirtyTwoBytesNoneZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, key);
        return ret_hu_conv;
    }
     ...
     */
    hash() {
        const ret = bindings.Bolt12Invoice_hash(this.ptr);
        return ret;
    }
    /**
     ...
     */
    write() {
        const ret = bindings.Bolt12Invoice_write(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
    ...
    static constructor_read(ser) {
        const ret = bindings.Bolt12Invoice_read(bindings.encodeUint8Array(ser));
        const ret_hu_conv = Result_Bolt12InvoiceDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
//# sourceMappingURL=Bolt12Invoice.mjs.map