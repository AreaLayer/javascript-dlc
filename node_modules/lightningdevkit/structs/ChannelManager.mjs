...
export class ChannelManager extends CommonBase {
     ...
     */
    create_channel(their_network_key, channel_value_satoshis, push_msat, user_channel_id, temporary_channel_id, override_config) {
        const ret = bindings.ChannelManager_create_channel(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(their_network_key, 33)), channel_value_satoshis, push_msat, bindings.encodeUint128(user_channel_id), temporary_channel_id == null ? 0n : CommonBase.get_ptr_of(temporary_channel_id), override_config == null ? 0n : CommonBase.get_ptr_of(override_config));
        const ret_hu_conv = Result_ChannelIdAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
    ...
    list_channels_with_counterparty(counterparty_node_id) {
        const ret = bindings.ChannelManager_list_channels_with_counterparty(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)));
        const ret_conv_16_len = bindings.getArrayLength(ret);
        const ret_conv_16_arr = new Array(ret_conv_16_len).fill(null);
        for (var q = 0; q < ret_conv_16_len; q++) {
            const ret_conv_16 = bindings.getU64ArrayElem(ret, q);
    ...
    list_recent_payments() {
        const ret = bindings.ChannelManager_list_recent_payments(this.ptr);
        const ret_conv_22_len = bindings.getArrayLength(ret);
        const ret_conv_22_arr = new Array(ret_conv_22_len).fill(null);
        for (var w = 0; w < ret_conv_22_len; w++) {
            const ret_conv_22 = bindings.getU64ArrayElem(ret, w);
            const ret_conv_22_hu_conv = RecentPaymentDetails.constr_from_ptr(ret_conv_22);
    ...
    close_channel(channel_id, counterparty_node_id) {
        const ret = bindings.ChannelManager_close_channel(this.ptr, CommonBase.get_ptr_of(channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)));
     ...
     */
    force_close_broadcasting_latest_txn(channel_id, counterparty_node_id, error_message) {
        const ret = bindings.ChannelManager_force_close_broadcasting_latest_txn(this.ptr, CommonBase.get_ptr_of(channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeString(error_message));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, channel_id);
        return ret_hu_conv;
    }
     ...
     */
    force_close_without_broadcasting_txn(channel_id, counterparty_node_id, error_message) {
        const ret = bindings.ChannelManager_force_close_without_broadcasting_txn(this.ptr, CommonBase.get_ptr_of(channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeString(error_message));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, channel_id);
        return ret_hu_conv;
    }
     ...
     * be a human-readable description of what went wrong.
     */
    force_close_all_channels_broadcasting_latest_txn(error_message) {
     ...
     */
    force_close_all_channels_without_broadcasting_txn(error_message) {
    ...
    send_payment_with_route(route, payment_hash, recipient_onion, payment_id) {
        const ret = bindings.ChannelManager_send_payment_with_route(this.ptr, CommonBase.get_ptr_of(route), bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), CommonBase.get_ptr_of(recipient_onion), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
     ...
     */
    send_payment(payment_hash, recipient_onion, payment_id, route_params, retry_strategy) {
        const ret = bindings.ChannelManager_send_payment(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), CommonBase.get_ptr_of(recipient_onion), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), CommonBase.get_ptr_of(route_params), CommonBase.get_ptr_of(retry_strategy));
        const ret_hu_conv = Result_NoneRetryableSendFailureZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     * [`send_payment`]: Self::send_payment
     */
    send_spontaneous_payment(route, payment_preimage, recipient_onion, payment_id) {
        const ret = bindings.ChannelManager_send_spontaneous_payment(this.ptr, CommonBase.get_ptr_of(route), CommonBase.get_ptr_of(payment_preimage), CommonBase.get_ptr_of(recipient_onion), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
        const ret_hu_conv = Result_ThirtyTwoBytesPaymentSendFailureZ.constr_from_ptr(ret);
     ...
     */
    send_spontaneous_payment_with_retry(payment_preimage, recipient_onion, payment_id, route_params, retry_strategy) {
        const ret = bindings.ChannelManager_send_spontaneous_payment_with_retry(this.ptr, CommonBase.get_ptr_of(payment_preimage), CommonBase.get_ptr_of(recipient_onion), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), CommonBase.get_ptr_of(route_params), CommonBase.get_ptr_of(retry_strategy));
        const ret_hu_conv = Result_ThirtyTwoBytesRetryableSendFailureZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    send_probe(path) {
        const ret = bindings.ChannelManager_send_probe(this.ptr, CommonBase.get_ptr_of(path));
        const ret_hu_conv = Result_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZPaymentSendFailureZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    send_spontaneous_preflight_probes(node_id, amount_msat, final_cltv_expiry_delta, liquidity_limit_multiplier) {
        const ret = bindings.ChannelManager_send_spontaneous_preflight_probes(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(node_id, 33)), amount_msat, final_cltv_expiry_delta, CommonBase.get_ptr_of(liquidity_limit_multiplier));
        const ret_hu_conv = Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbeSendFailureZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
    ...
    send_preflight_probes(route_params, liquidity_limit_multiplier) {
        const ret = bindings.ChannelManager_send_preflight_probes(this.ptr, CommonBase.get_ptr_of(route_params), CommonBase.get_ptr_of(liquidity_limit_multiplier));
        const ret_hu_conv = Result_CVec_C2Tuple_ThirtyTwoBytesThirtyTwoBytesZZProbeSendFailureZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
    ...
    funding_transaction_generated(temporary_channel_id, counterparty_node_id, funding_transaction) {
        const ret = bindings.ChannelManager_funding_transaction_generated(this.ptr, CommonBase.get_ptr_of(temporary_channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeUint8Array(funding_transaction));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    unsafe_manual_funding_transaction_generated(temporary_channel_id, counterparty_node_id, funding) {
        const ret = bindings.ChannelManager_unsafe_manual_funding_transaction_generated(this.ptr, CommonBase.get_ptr_of(temporary_channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), CommonBase.get_ptr_of(funding));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    batch_funding_transaction_generated(temporary_channels, funding_transaction) {
        const ret = bindings.ChannelManager_batch_funding_transaction_generated(this.ptr, bindings.encodeUint64Array(temporary_channels.map(temporary_channels_conv_30 => CommonBase.get_ptr_of(temporary_channels_conv_30))), bindings.encodeUint8Array(funding_transaction));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    update_partial_channel_config(counterparty_node_id, channel_ids, config_update) {
        const ret = bindings.ChannelManager_update_partial_channel_config(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeUint64Array(channel_ids.map(channel_ids_conv_11 => CommonBase.get_ptr_of(channel_ids_conv_11))), CommonBase.get_ptr_of(config_update));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
    ...
    update_channel_config(counterparty_node_id, channel_ids, config) {
        const ret = bindings.ChannelManager_update_channel_config(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeUint64Array(channel_ids.map(channel_ids_conv_11 => CommonBase.get_ptr_of(channel_ids_conv_11))), CommonBase.get_ptr_of(config));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
     ...
     */
    forward_intercepted_htlc(intercept_id, next_hop_channel_id, next_node_id, amt_to_forward_msat) {
        const ret = bindings.ChannelManager_forward_intercepted_htlc(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(intercept_id, 32)), CommonBase.get_ptr_of(next_hop_channel_id), bindings.encodeUint8Array(bindings.check_arr_len(next_node_id, 33)), amt_to_forward_msat);
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
    ...
    fail_intercepted_htlc(intercept_id) {
        const ret = bindings.ChannelManager_fail_intercepted_htlc(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(intercept_id, 32)));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    fail_htlc_backwards_with_reason(payment_hash, failure_code) {
     ...
     * [`claim_funds`]: Self::claim_funds
     */
    claim_funds_with_known_custom_tlvs(payment_preimage) {
    ...
    accept_inbound_channel(temporary_channel_id, counterparty_node_id, user_channel_id) {
        const ret = bindings.ChannelManager_accept_inbound_channel(this.ptr, CommonBase.get_ptr_of(temporary_channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeUint128(user_channel_id));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
    ...
    accept_inbound_channel_from_trusted_peer_0conf(temporary_channel_id, counterparty_node_id, user_channel_id) {
        const ret = bindings.ChannelManager_accept_inbound_channel_from_trusted_peer_0conf(this.ptr, CommonBase.get_ptr_of(temporary_channel_id), bindings.encodeUint8Array(bindings.check_arr_len(counterparty_node_id, 33)), bindings.encodeUint128(user_channel_id));
        const ret_hu_conv = Result_NoneAPIErrorZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, temporary_channel_id);
        return ret_hu_conv;
    }
     ...
     */
    create_offer_builder(absolute_expiry) {
        const ret = bindings.ChannelManager_create_offer_builder(this.ptr, CommonBase.get_ptr_of(absolute_expiry));
        const ret_hu_conv = Result_OfferWithDerivedMetadataBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    create_refund_builder(amount_msats, absolute_expiry, payment_id, retry_strategy, max_total_routing_fee_msat) {
        const ret = bindings.ChannelManager_create_refund_builder(this.ptr, amount_msats, absolute_expiry, bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), CommonBase.get_ptr_of(retry_strategy), CommonBase.get_ptr_of(max_total_routing_fee_msat));
    ...
    request_refund_payment(refund) {
        const ret = bindings.ChannelManager_request_refund_payment(this.ptr, CommonBase.get_ptr_of(refund));
     ...
     * [`create_inbound_payment_for_hash`]: Self::create_inbound_payment_for_hash
     */
    create_inbound_payment(min_value_msat, invoice_expiry_delta_secs, min_final_cltv_expiry_delta) {
        const ret = bindings.ChannelManager_create_inbound_payment(this.ptr, CommonBase.get_ptr_of(min_value_msat), invoice_expiry_delta_secs, CommonBase.get_ptr_of(min_final_cltv_expiry_delta));
     ...
     * [`PaymentClaimable`]: events::Event::PaymentClaimable
     */
    create_inbound_payment_for_hash(payment_hash, min_value_msat, invoice_expiry_delta_secs, min_final_cltv_expiry) {
        const ret = bindings.ChannelManager_create_inbound_payment_for_hash(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), CommonBase.get_ptr_of(min_value_msat), invoice_expiry_delta_secs, CommonBase.get_ptr_of(min_final_cltv_expiry));
    ...
    get_payment_preimage(payment_hash, payment_secret) {
        ...
        const ret_hu_conv = Result_ThirtyTwoBytesAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    get_intercept_scid() {
        const ret = bindings.ChannelManager_get_intercept_scid(this.ptr);
        return ret;
    }
    /**
    ...
    compute_inflight_htlcs() {
        const ret = bindings.ChannelManager_compute_inflight_htlcs(this.ptr);
    ...
    get_event_or_persistence_needed_future() {
        const ret = bindings.ChannelManager_get_event_or_persistence_needed_future(this.ptr);
    ...
    get_and_clear_needs_persistence() {
        const ret = bindings.ChannelManager_get_and_clear_needs_persistence(this.ptr);
        return ret;
    }
    /**
     ...
     */
    node_features() {
        const ret = bindings.ChannelManager_node_features(this.ptr);
     ...
     */
    channel_features() {
        const ret = bindings.ChannelManager_channel_features(this.ptr);
    ...
    channel_type_features() {
        const ret = bindings.ChannelManager_channel_type_features(this.ptr);
     ...
     */
    init_features() {
        const ret = bindings.ChannelManager_init_features(this.ptr);
    ...
    as_OffersMessageHandler() {
        const ret = bindings.ChannelManager_as_OffersMessageHandler(this.ptr);
        const ret_hu_conv = new OffersMessageHandler(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
    /**
    ...
    as_AsyncPaymentsMessageHandler() {
        const ret = bindings.ChannelManager_as_AsyncPaymentsMessageHandler(this.ptr);
        const ret_hu_conv = new AsyncPaymentsMessageHandler(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
    /**
     ...
     */
    as_NodeIdLookUp() {
        const ret = bindings.ChannelManager_as_NodeIdLookUp(this.ptr);
