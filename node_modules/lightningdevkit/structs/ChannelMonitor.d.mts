 ...
 */
export declare class ChannelMonitor extends CommonBase {
    clone_ptr(): bigint;
    /**
     * Creates a copy of the ChannelMonitor
     */
    clone(): ChannelMonitor;
    /**
     ...
     */
    update_monitor(updates: ChannelMonitorUpdate, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): Result_NoneNoneZ;
    /**
     * Gets the update_id from the latest ChannelMonitorUpdate which was applied to this
     * ChannelMonitor.
     */
    get_latest_update_id(): bigint;
    /**
     * Gets the funding transaction outpoint of the channel this ChannelMonitor is monitoring for.
     */
    get_funding_txo(): TwoTuple_OutPointCVec_u8ZZ;
    /**
     ...
     */
    get_outputs_to_watch(): TwoTuple_ThirtyTwoBytesCVec_C2Tuple_u32CVec_u8ZZZZ[];
    /**
     * Loads the funding txo and outputs to watch into the given `chain::Filter` by repeatedly
     * calling `chain::Filter::register_output` and `chain::Filter::register_tx` until all outputs
     * have been registered.
     */
    load_outputs_to_watch(filter: Filter, logger: Logger): void;
    /**
     * Get the list of HTLCs who's status has been updated on chain. This should be called by
     * ChannelManager via [`chain::Watch::release_pending_monitor_events`].
     */
    get_and_clear_pending_monitor_events(): MonitorEvent[];
    /**
     ...
     */
    process_pending_events(handler: EventHandler): Result_NoneReplayEventZ;
    /**
     ...
     */
    initial_counterparty_commitment_tx(): CommitmentTransaction;
    /**
     ...
     */
    counterparty_commitment_txs_from_update(update: ChannelMonitorUpdate): CommitmentTransaction[];
    /**
     ...
     */
    sign_to_local_justice_tx(justice_tx: Uint8Array, input_idx: number, value: bigint, commitment_number: bigint): Result_TransactionNoneZ;
    /**
     ...
     * to you.
     */
    broadcast_latest_holder_commitment_txn(broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): void;
    /**
     ...
     */
    block_connected(header: Uint8Array, txdata: TwoTuple_usizeTransactionZ[], height: number, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): TwoTuple_ThirtyTwoBytesCVec_C2Tuple_u32TxOutZZZ[];
    /**
     * Determines if the disconnected block contained any transactions of interest and updates
     * appropriately.
     */
    block_disconnected(header: Uint8Array, height: number, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): void;
    /**
     ...
     */
    transactions_confirmed(header: Uint8Array, txdata: TwoTuple_usizeTransactionZ[], height: number, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): TwoTuple_ThirtyTwoBytesCVec_C2Tuple_u32TxOutZZZ[];
    /**
     ...
     */
    transaction_unconfirmed(txid: Uint8Array, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): void;
    /**
     ...
     * [`block_connected`]: Self::block_connected
     */
    best_block_updated(header: Uint8Array, height: number, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): TwoTuple_ThirtyTwoBytesCVec_C2Tuple_u32TxOutZZZ[];
    /**
     ...
     */
    rebroadcast_pending_claims(broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): void;
    /**
     ...
     */
    signer_unblocked(broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, logger: Logger): void;
    /**
     ...
     */
    get_spendable_outputs(tx: Uint8Array, confirmation_height: number): SpendableOutputDescriptor[];
    /**
     ...
     */
    is_fully_resolved(logger: Logger): boolean;
    /**
     ...
     */
    get_claimable_balances(): Balance[];
}
