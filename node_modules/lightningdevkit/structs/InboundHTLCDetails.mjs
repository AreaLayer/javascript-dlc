...
export class InboundHTLCDetails extends CommonBase {
     ...
     */
    get_htlc_id() {
        const ret = bindings.InboundHTLCDetails_get_htlc_id(this.ptr);
        return ret;
    }
    /**
     * The HTLC ID.
     ...
     */
    get_amount_msat() {
        const ret = bindings.InboundHTLCDetails_get_amount_msat(this.ptr);
        return ret;
    }
    /**
     * The amount in msat.
     ...
     */
    get_cltv_expiry() {
        const ret = bindings.InboundHTLCDetails_get_cltv_expiry(this.ptr);
        return ret;
    }
    /**
     * The block height at which this HTLC expires.
     ...
     */
    get_payment_hash() {
        const ret = bindings.InboundHTLCDetails_get_payment_hash(this.ptr);
    ...
    set_payment_hash(val) {
        bindings.InboundHTLCDetails_set_payment_hash(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
    }
    /**
     ...
     */
    get_state() {
        const ret = bindings.InboundHTLCDetails_get_state(this.ptr);
        const ret_hu_conv = Option_InboundHTLCStateDetailsZ.constr_from_ptr(ret);
     ...
     */
    get_is_dust() {
        const ret = bindings.InboundHTLCDetails_get_is_dust(this.ptr);
        return ret;
    }
    /**
     * Whether the HTLC has an output below the local dust limit. If so, the output will be trimmed
     ...
     */
    static constructor_new(htlc_id_arg, amount_msat_arg, cltv_expiry_arg, payment_hash_arg, state_arg, is_dust_arg) {
        const ret = bindings.InboundHTLCDetails_new(htlc_id_arg, amount_msat_arg, cltv_expiry_arg, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash_arg, 32)), CommonBase.get_ptr_of(state_arg), is_dust_arg);
        const ret_hu_conv = new InboundHTLCDetails(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
        return ret_hu_conv;
    }
    clone_ptr() {
        const ret = bindings.InboundHTLCDetails_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.InboundHTLCDetails_clone(this.ptr);
        const ret_hu_conv = new InboundHTLCDetails(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
     ...
     */
    write() {
        const ret = bindings.InboundHTLCDetails_write(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
    ...
    static constructor_read(ser) {
        const ret = bindings.InboundHTLCDetails_read(bindings.encodeUint8Array(ser));
        const ret_hu_conv = Result_InboundHTLCDetailsDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
//# sourceMappingURL=InboundHTLCDetails.mjs.map