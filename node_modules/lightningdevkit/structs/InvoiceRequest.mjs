...
export class InvoiceRequest extends CommonBase {
    ...
    clone_ptr() {
        const ret = bindings.InvoiceRequest_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.InvoiceRequest_clone(this.ptr);
        const ret_hu_conv = new InvoiceRequest(null, ret);
     ...
     */
    chains() {
        const ret = bindings.InvoiceRequest_chains(this.ptr);
     ...
     */
    metadata() {
        const ret = bindings.InvoiceRequest_metadata(this.ptr);
     ...
     */
    amount() {
        const ret = bindings.InvoiceRequest_amount(this.ptr);
     ...
     */
    description() {
        const ret = bindings.InvoiceRequest_description(this.ptr);
     ...
     */
    offer_features() {
        const ret = bindings.InvoiceRequest_offer_features(this.ptr);
     ...
     */
    absolute_expiry() {
        const ret = bindings.InvoiceRequest_absolute_expiry(this.ptr);
     ...
     */
    issuer() {
        const ret = bindings.InvoiceRequest_issuer(this.ptr);
        const ret_hu_conv = new PrintableString(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
     ...
     */
    paths() {
        const ret = bindings.InvoiceRequest_paths(this.ptr);
     ...
     */
    supported_quantity() {
        const ret = bindings.InvoiceRequest_supported_quantity(this.ptr);
     ...
     */
    signing_pubkey() {
        const ret = bindings.InvoiceRequest_signing_pubkey(this.ptr);
     ...
     */
    payer_metadata() {
        const ret = bindings.InvoiceRequest_payer_metadata(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    chain() {
        const ret = bindings.InvoiceRequest_chain(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    amount_msats() {
        const ret = bindings.InvoiceRequest_amount_msats(this.ptr);
        const ret_hu_conv = Option_u64Z.constr_from_ptr(ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
    ...
    invoice_request_features() {
        const ret = bindings.InvoiceRequest_invoice_request_features(this.ptr);
     ...
     */
    quantity() {
        const ret = bindings.InvoiceRequest_quantity(this.ptr);
        const ret_hu_conv = Option_u64Z.constr_from_ptr(ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
     ...
     */
    payer_id() {
        const ret = bindings.InvoiceRequest_payer_id(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    payer_note() {
        const ret = bindings.InvoiceRequest_payer_note(this.ptr);
        const ret_hu_conv = new PrintableString(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
    ...
    respond_with_no_std(payment_paths, payment_hash, created_at) {
        const ret = bindings.InvoiceRequest_respond_with_no_std(this.ptr, bindings.encodeUint64Array(payment_paths.map(payment_paths_conv_20 => CommonBase.get_ptr_of(payment_paths_conv_20))), bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), created_at);
    ...
    verify_using_metadata(key) {
        const ret = bindings.InvoiceRequest_verify_using_metadata(this.ptr, CommonBase.get_ptr_of(key));
        const ret_hu_conv = Result_VerifiedInvoiceRequestNoneZ.constr_from_ptr(ret);
     ...
     * [`Bolt12Invoice`]: crate::offers::invoice::Bolt12Invoice
     */
    verify_using_recipient_data(nonce, key) {
        const ret = bindings.InvoiceRequest_verify_using_recipient_data(this.ptr, CommonBase.get_ptr_of(nonce), CommonBase.get_ptr_of(key));
        const ret_hu_conv = Result_VerifiedInvoiceRequestNoneZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, key);
        return ret_hu_conv;
    }
     ...
     */
    signature() {
        const ret = bindings.InvoiceRequest_signature(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
    /**
     ...
     */
    write() {
        const ret = bindings.InvoiceRequest_write(this.ptr);
        const ret_conv = bindings.decodeUint8Array(ret);
        return ret_conv;
    }
}
//# sourceMappingURL=InvoiceRequest.mjs.map