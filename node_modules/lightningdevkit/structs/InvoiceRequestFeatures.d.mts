...
export declare class InvoiceRequestFeatures extends CommonBase {
     ...
     */
    static constructor_empty(): InvoiceRequestFeatures;
    /**
     ...
     */
    requires_unknown_bits_from(other: InvoiceRequestFeatures): boolean;
    /**
     * Returns the set of required features unknown by `other`, as their bit position.
     */
    required_unknown_bits_from(other: InvoiceRequestFeatures): bigint[];
    /**
