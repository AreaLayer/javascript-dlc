...
export class MonitorUpdatingPersister extends CommonBase {
     ...
     */
    static constructor_new(kv_store, logger, maximum_pending_updates, entropy_source, signer_provider, broadcaster, fee_estimator) {
        const ret = bindings.MonitorUpdatingPersister_new(CommonBase.get_ptr_of(kv_store), CommonBase.get_ptr_of(logger), maximum_pending_updates, CommonBase.get_ptr_of(entropy_source), CommonBase.get_ptr_of(signer_provider), CommonBase.get_ptr_of(broadcaster), CommonBase.get_ptr_of(fee_estimator));
        const ret_hu_conv = new MonitorUpdatingPersister(null, ret);
    ...
    read_all_channel_monitors_with_updates() {
        const ret = bindings.MonitorUpdatingPersister_read_all_channel_monitors_with_updates(this.ptr);
     ...
     */
    read_channel_monitor_with_updates(monitor_key) {
        const ret = bindings.MonitorUpdatingPersister_read_channel_monitor_with_updates(this.ptr, bindings.encodeString(monitor_key));
        const ret_hu_conv = Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    cleanup_stale_updates(lazy) {
        const ret = bindings.MonitorUpdatingPersister_cleanup_stale_updates(this.ptr, lazy);
     ...
     */
    as_Persist() {
        const ret = bindings.MonitorUpdatingPersister_as_Persist(this.ptr);
        const ret_hu_conv = new Persist(null, ret);
        CommonBase.add_ref_from(ret_hu_conv, this);
        return ret_hu_conv;
    }
}
//# sourceMappingURL=MonitorUpdatingPersister.mjs.map