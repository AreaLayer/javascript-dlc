...
export class OnionMessage extends CommonBase {
    ...
    get_onion_routing_packet() {
        const ret = bindings.OnionMessage_get_onion_routing_packet(this.ptr);
     ...
     */
    static constructor_new(blinding_point_arg, onion_routing_packet_arg) {
        const ret = bindings.OnionMessage_new(bindings.encodeUint8Array(bindings.check_arr_len(blinding_point_arg, 33)), CommonBase.get_ptr_of(onion_routing_packet_arg));
     ...
     */
    hash() {
        const ret = bindings.OnionMessage_hash(this.ptr);
        return ret;
    }
    /**
     ...
     */
    eq(b) {
        const ret = bindings.OnionMessage_eq(this.ptr, CommonBase.get_ptr_of(b));
