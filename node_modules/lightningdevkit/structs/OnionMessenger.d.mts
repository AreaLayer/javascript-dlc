...
export declare class OnionMessenger extends CommonBase {
     ...
     */
    static constructor_new(entropy_source: EntropySource, node_signer: NodeSigner, logger: Logger, node_id_lookup: NodeIdLookUp, message_router: MessageRouter, offers_handler: OffersMessageHandler, async_payments_handler: AsyncPaymentsMessageHandler, custom_handler: CustomOnionMessageHandler): OnionMessenger;
    /**
     ...
     * peers.
     */
    static constructor_new_with_offline_peer_interception(entropy_source: EntropySource, node_signer: NodeSigner, logger: Logger, node_id_lookup: NodeIdLookUp, message_router: MessageRouter, offers_handler: OffersMessageHandler, async_payments_handler: AsyncPaymentsMessageHandler, custom_handler: CustomOnionMessageHandler): OnionMessenger;
    /**
