...
export class Option_OutboundHTLCStateDetailsZ extends CommonBase {
    constructor(_dummy, ptr) { super(ptr, bindings.COption_OutboundHTLCStateDetailsZ_free); }
    /* @internal */
    static constr_from_ptr(ptr) {
        const raw_ty = bindings.LDKCOption_OutboundHTLCStateDetailsZ_ty_from_ptr(ptr);
        switch (raw_ty) {
    ...
    static constructor_some(o) {
        const ret = bindings.COption_OutboundHTLCStateDetailsZ_some(o);
    ...
    static constructor_none() {
        const ret = bindings.COption_OutboundHTLCStateDetailsZ_none();
        const ret_hu_conv = Option_OutboundHTLCStateDetailsZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
        return ret_hu_conv;
    }
    clone_ptr() {
        const ret = bindings.COption_OutboundHTLCStateDetailsZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.COption_OutboundHTLCStateDetailsZ_clone(this.ptr);
        const ret_hu_conv = Option_OutboundHTLCStateDetailsZ.constr_from_ptr(ret);
...
//# sourceMappingURL=Option_OutboundHTLCStateDetailsZ.mjs.map