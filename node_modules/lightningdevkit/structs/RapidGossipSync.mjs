...
export class RapidGossipSync extends CommonBase {
     ...
     */
    static constructor_new(network_graph, logger) {
        const ret = bindings.RapidGossipSync_new(CommonBase.get_ptr_of(network_graph), CommonBase.get_ptr_of(logger));
     ...
     */
    update_network_graph_no_std(update_data, current_time_unix) {
        const ret = bindings.RapidGossipSync_update_network_graph_no_std(this.ptr, bindings.encodeUint8Array(update_data), CommonBase.get_ptr_of(current_time_unix));
