 ...
 */
export declare class RecipientOnionFields extends CommonBase {
    /**
     ...
     */
    get_payment_secret(): Option_ThirtyTwoBytesZ;
    /**
     * The [`PaymentSecret`] is an arbitrary 32 bytes provided by the recipient for us to repeat
     * in the onion. It is unrelated to `payment_hash` (or [`PaymentPreimage`]) and exists to
     * authenticate the sender to the recipient and prevent payment-probing (deanonymization)
     ...
     * recipient will not reject it.
     */
    set_payment_secret(val: Option_ThirtyTwoBytesZ): void;
    /**
     ...
     */
    get_payment_metadata(): Option_CVec_u8ZZ;
    /**
     * The payment metadata serves a similar purpose as [`Self::payment_secret`] but is of
     * arbitrary length. This gives recipients substantially more flexibility to receive
     * additional data.
     ...
     */
    static constructor_read(ser: Uint8Array): Result_RecipientOnionFieldsDecodeErrorZ;
    /**
     * Creates a [`RecipientOnionFields`] from only a [`PaymentSecret`]. This is the most common
     * set of onion fields for today's BOLT11 invoices - most nodes require a [`PaymentSecret`]
     * but do not require or provide any further data.
     */
    static constructor_secret_only(payment_secret: Uint8Array): RecipientOnionFields;
    /**
     ...
     */
    static constructor_spontaneous_empty(): RecipientOnionFields;
    /**
     ...
     */
    with_custom_tlvs(custom_tlvs: TwoTuple_u64CVec_u8ZZ[]): Result_RecipientOnionFieldsNoneZ;
    /**
