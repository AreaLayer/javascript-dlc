...
export class Result_BlindedHopDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_BlindedHopDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_BlindedHopDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_BlindedHopDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
    ...
    clone_ptr() {
        const ret = bindings.CResult_BlindedHopDecodeErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_BlindedHopDecodeErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_BlindedHopDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
