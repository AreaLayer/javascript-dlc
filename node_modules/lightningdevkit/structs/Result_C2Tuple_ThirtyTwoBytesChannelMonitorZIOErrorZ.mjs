...
export class Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_err(e);
        const ret_hu_conv = Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_OK extends Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ_get_ok(ptr);
        const res_hu_conv = new TwoTuple_ThirtyTwoBytesChannelMonitorZ(null, res);
...
//# sourceMappingURL=Result_C2Tuple_ThirtyTwoBytesChannelMonitorZIOErrorZ.mjs.map