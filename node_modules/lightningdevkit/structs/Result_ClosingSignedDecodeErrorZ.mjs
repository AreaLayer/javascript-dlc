...
export class Result_ClosingSignedDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_ClosingSignedDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_ClosingSignedDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_ClosingSignedDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
