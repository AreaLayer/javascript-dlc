...
export class Result_ECDSASignatureNoneZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_ECDSASignatureNoneZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 64)));
    ...
    static constructor_err() {
        const ret = bindings.CResult_ECDSASignatureNoneZ_err();
        const ret_hu_conv = Result_ECDSASignatureNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_ECDSASignatureNoneZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_ECDSASignatureNoneZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_ECDSASignatureNoneZ_clone(this.ptr);
        const ret_hu_conv = Result_ECDSASignatureNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_ECDSASignatureNoneZ_OK extends Result_ECDSASignatureNoneZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_ECDSASignatureNoneZ_get_ok(ptr);
...
//# sourceMappingURL=Result_ECDSASignatureNoneZ.mjs.map