...
export class Result_InMemorySignerDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_InMemorySignerDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_InMemorySignerDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_InMemorySignerDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
