...
export class Result_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ_err(e);
        const ret_hu_conv = Result_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ_is_ok(this.ptr);
        return ret;
    }
}
export class Result_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ_OK extends Result_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ_get_ok(ptr);
        const res_hu_conv = new InvoiceWithExplicitSigningPubkeyBuilder(null, res);
...
//# sourceMappingURL=Result_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ.mjs.map