...
export class Result_NodeIdDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_NodeIdDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_NodeIdDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_NodeIdDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_NodeIdDecodeErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_NodeIdDecodeErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_NodeIdDecodeErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_NodeIdDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_NodeIdDecodeErrorZ_OK extends Result_NodeIdDecodeErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_NodeIdDecodeErrorZ_get_ok(ptr);
        const res_hu_conv = new NodeId(null, res);
...
export class Result_NodeIdDecodeErrorZ_Err extends Result_NodeIdDecodeErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const err = bindings.CResult_NodeIdDecodeErrorZ_get_err(ptr);
