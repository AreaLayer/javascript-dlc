...
export class Result_NoneBolt12SemanticErrorZ extends CommonBase {
    ...
    static constructor_ok() {
        const ret = bindings.CResult_NoneBolt12SemanticErrorZ_ok();
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_NoneBolt12SemanticErrorZ_err(e);
        const ret_hu_conv = Result_NoneBolt12SemanticErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_NoneBolt12SemanticErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_NoneBolt12SemanticErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_NoneBolt12SemanticErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_NoneBolt12SemanticErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
...
//# sourceMappingURL=Result_NoneBolt12SemanticErrorZ.mjs.map