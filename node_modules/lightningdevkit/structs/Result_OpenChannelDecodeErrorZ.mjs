...
export class Result_OpenChannelDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_OpenChannelDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_OpenChannelDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_OpenChannelDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_OpenChannelDecodeErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_OpenChannelDecodeErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_OpenChannelDecodeErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_OpenChannelDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_OpenChannelDecodeErrorZ_OK extends Result_OpenChannelDecodeErrorZ {
    /* @internal */
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_OpenChannelDecodeErrorZ_get_ok(ptr);
        const res_hu_conv = new OpenChannel(null, res);
        CommonBase.add_ref_from(res_hu_conv, this);
        this.res = res_hu_conv;
    }
}
export class Result_OpenChannelDecodeErrorZ_Err extends Result_OpenChannelDecodeErrorZ {
    /* @internal */
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const err = bindings.CResult_OpenChannelDecodeErrorZ_get_err(ptr);
