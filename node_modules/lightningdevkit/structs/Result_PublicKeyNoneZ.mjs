...
export class Result_PublicKeyNoneZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_PublicKeyNoneZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 33)));
    ...
    static constructor_err() {
        const ret = bindings.CResult_PublicKeyNoneZ_err();
        const ret_hu_conv = Result_PublicKeyNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_PublicKeyNoneZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_PublicKeyNoneZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_PublicKeyNoneZ_clone(this.ptr);
        const ret_hu_conv = Result_PublicKeyNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_PublicKeyNoneZ_OK extends Result_PublicKeyNoneZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_PublicKeyNoneZ_get_ok(ptr);
...
//# sourceMappingURL=Result_PublicKeyNoneZ.mjs.map