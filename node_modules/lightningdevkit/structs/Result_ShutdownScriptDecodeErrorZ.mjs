...
export class Result_ShutdownScriptDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_ShutdownScriptDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_ShutdownScriptDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_ShutdownScriptDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_ShutdownScriptDecodeErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_ShutdownScriptDecodeErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_ShutdownScriptDecodeErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_ShutdownScriptDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_ShutdownScriptDecodeErrorZ_OK extends Result_ShutdownScriptDecodeErrorZ {
    /* @internal */
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_ShutdownScriptDecodeErrorZ_get_ok(ptr);
        const res_hu_conv = new ShutdownScript(null, res);
        CommonBase.add_ref_from(res_hu_conv, this);
        this.res = res_hu_conv;
    }
}
export class Result_ShutdownScriptDecodeErrorZ_Err extends Result_ShutdownScriptDecodeErrorZ {
    /* @internal */
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const err = bindings.CResult_ShutdownScriptDecodeErrorZ_get_err(ptr);
