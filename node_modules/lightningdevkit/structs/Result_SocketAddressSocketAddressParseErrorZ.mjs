...
export class Result_SocketAddressSocketAddressParseErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_SocketAddressSocketAddressParseErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_SocketAddressSocketAddressParseErrorZ_err(e);
        const ret_hu_conv = Result_SocketAddressSocketAddressParseErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_SocketAddressSocketAddressParseErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_SocketAddressSocketAddressParseErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_SocketAddressSocketAddressParseErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_SocketAddressSocketAddressParseErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_SocketAddressSocketAddressParseErrorZ_OK extends Result_SocketAddressSocketAddressParseErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_SocketAddressSocketAddressParseErrorZ_get_ok(ptr);
        const res_hu_conv = SocketAddress.constr_from_ptr(res);
...
//# sourceMappingURL=Result_SocketAddressSocketAddressParseErrorZ.mjs.map