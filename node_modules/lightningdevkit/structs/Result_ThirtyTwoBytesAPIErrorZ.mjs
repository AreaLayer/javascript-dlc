...
export class Result_ThirtyTwoBytesAPIErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_ThirtyTwoBytesAPIErrorZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_ThirtyTwoBytesAPIErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_ThirtyTwoBytesAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_ThirtyTwoBytesAPIErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_ThirtyTwoBytesAPIErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_ThirtyTwoBytesAPIErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_ThirtyTwoBytesAPIErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_ThirtyTwoBytesAPIErrorZ_OK extends Result_ThirtyTwoBytesAPIErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_ThirtyTwoBytesAPIErrorZ_get_ok(ptr);
...
export class Result_ThirtyTwoBytesAPIErrorZ_Err extends Result_ThirtyTwoBytesAPIErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const err = bindings.CResult_ThirtyTwoBytesAPIErrorZ_get_err(ptr);
        const err_hu_conv = APIError.constr_from_ptr(err);
        CommonBase.add_ref_from(err_hu_conv, this);
        this.err = err_hu_conv;
    }
}
//# sourceMappingURL=Result_ThirtyTwoBytesAPIErrorZ.mjs.map