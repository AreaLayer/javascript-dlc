...
export class Result_TxCompleteDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_TxCompleteDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_TxCompleteDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_TxCompleteDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_TxCompleteDecodeErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_TxCompleteDecodeErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_TxCompleteDecodeErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_TxCompleteDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_TxCompleteDecodeErrorZ_OK extends Result_TxCompleteDecodeErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_TxCompleteDecodeErrorZ_get_ok(ptr);
        const res_hu_conv = new TxComplete(null, res);
...
export class Result_TxCompleteDecodeErrorZ_Err extends Result_TxCompleteDecodeErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const err = bindings.CResult_TxCompleteDecodeErrorZ_get_err(ptr);
        const err_hu_conv = DecodeError.constr_from_ptr(err);
        CommonBase.add_ref_from(err_hu_conv, this);
        this.err = err_hu_conv;
    }
}
//# sourceMappingURL=Result_TxCompleteDecodeErrorZ.mjs.map