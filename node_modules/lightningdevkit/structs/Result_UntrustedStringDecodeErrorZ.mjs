...
export class Result_UntrustedStringDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_UntrustedStringDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_UntrustedStringDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_UntrustedStringDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_UntrustedStringDecodeErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_UntrustedStringDecodeErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_UntrustedStringDecodeErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_UntrustedStringDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_UntrustedStringDecodeErrorZ_OK extends Result_UntrustedStringDecodeErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_UntrustedStringDecodeErrorZ_get_ok(ptr);
        const res_hu_conv = new UntrustedString(null, res);
...
export class Result_UntrustedStringDecodeErrorZ_Err extends Result_UntrustedStringDecodeErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const err = bindings.CResult_UntrustedStringDecodeErrorZ_get_err(ptr);
        const err_hu_conv = DecodeError.constr_from_ptr(err);
        CommonBase.add_ref_from(err_hu_conv, this);
        this.err = err_hu_conv;
    }
}
//# sourceMappingURL=Result_UntrustedStringDecodeErrorZ.mjs.map