...
export class Result_UpdateFailHTLCDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_UpdateFailHTLCDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_UpdateFailHTLCDecodeErrorZ_err(CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_UpdateFailHTLCDecodeErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
