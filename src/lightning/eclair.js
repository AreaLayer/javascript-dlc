...
async function signContractInput(lndClient, contractId, contractInfo, inputAmount, inputBlindingKey) {
  const request = {
    contractId,
    contractInfo,
    inputAmount,
...
const tlsCertPath = 'PATH_TO_TLS_CERT_FILE'; // Path to your LND TLS certificate file
